...
struct Style
{
    ...
    sf::FloatRect       main_rect;              ///< Texture rect of the main component
    ...
    sf::FloatRect       secondary_rect;         ///< Texture rect of the secondary component
    ...
    sf::FloatRect       background_rect;        ///< Texture rect of the background
